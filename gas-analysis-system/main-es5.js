...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetailsComponent = /** @class */ (function () {
                function DetailsComponent(dialog) {
                    this.dialog = dialog;
                    this.fakeData = [
                        {
                ...
                DetailsComponent.prototype.close = function () {
                    this.dialog.close();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InfoComponent = /** @class */ (function () {
                ...
                InfoComponent.prototype.close = function () {
                    this.dialog.close();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ControlPanelComponent = /** @class */ (function (_super) {
                __extends(ControlPanelComponent, _super);
                function ControlPanelComponent(dialogService) {
                    var _this = _super.call(this) || this;
                    _this.dialogService = dialogService;
                    _this.fakeDataItem = new _models_measured_data_model__WEBPACK_IMPORTED_MODULE_3__["MeasuredData"]();
                    _this.fakeData = [
                        {
                            date: '11/29/2019 -- 15:00',
                            temperature: 25,
                ...
                ControlPanelComponent.prototype.showHistory = function (item) {
                ...
                ControlPanelComponent.prototype.showInfo = function () {
                    this.dialogService.open({ content: _components_info_info_component__WEBPACK_IMPORTED_MODULE_6__["InfoComponent"] });
                };
                return ControlPanelComponent;
            }(packages_g_a_s_shared_shared_src_app_grid_grid_base_component__WEBPACK_IMPORTED_MODULE_4__["GridBaseComponent"]));
            ControlPanelComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ControlPanelRoutingModule = _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(controlPanelRoutes);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ControlPanelService = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var MeasuredData = /** @class */ (function () {
            ...
            var MeasuredDataFormErrorsViewModel = /** @class */ (function () {
                function MeasuredDataFormErrorsViewModel() {
                    this.date = null;
                    this.temperature = null;
                    this.concentration = null;
                    this.humidity = null;
                ...
                return MeasuredDataFormErrorsViewModel;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GridBaseComponent = /** @class */ (function () {
                ...
                Object.defineProperty(GridBaseComponent.prototype, "searchValue", {
                    get: function () {
                ...
                //     });
                // }
                GridBaseComponent.prototype.loadData = function (data) {
                    this.data = data;
                    this.loadGridView();
                };
                GridBaseComponent.prototype.pageChange = function (_a) {
                    var skip = _a.skip, take = _a.take;
                    this.skip = skip;
                    this.pageSize = take;
                    this.loadGridView();
                };
                GridBaseComponent.prototype.loadGridView = function () {
                    var filteredData = this.applyPagination(this.applySearch());
                    this.gridView = {
                        data: filteredData,
                        total: this.data.length
                    };
                };
                GridBaseComponent.prototype.applySearch = function () {
                    var _this = this;
                    if (!this.searchValue) {
                        return this.data;
                    }
                    return this.data.filter(function (item) {
                        return _this.checkIfItemContainsText(item, _this.searchValue);
                    });
                };
                GridBaseComponent.prototype.applyPagination = function (data) {
                    return data.slice(this.skip, this.skip + this.pageSize);
                };
                GridBaseComponent.prototype.checkIfItemContainsText = function (item, text) {
                    var itemFound = false;
